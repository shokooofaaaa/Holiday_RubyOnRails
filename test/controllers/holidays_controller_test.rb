...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    ...
    post holidays_url, params:{ holiday: {from: @holiday.from, to: @holiday.to, user_id: @holiday.user_id }}
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params:{ holiday: {from: @holiday.from, to: @holiday.to, user_id: @holiday.user_id}}
